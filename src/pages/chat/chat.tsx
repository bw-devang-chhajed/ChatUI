...
export const Chat = forwardRef<ChatRef>((_props, ref) => {
  useImperativeHandle(ref, () => ({
    resetChat() {
      console.log("Chat cleared!");
      resetChatFunc();
      // put your logic here (setState, zustand, etc.)
    },
  }));
  ...
  return (
      <div className="flex flex-col min-w-0 h-dvh bg-background">
        <Header/>
        <div className={`flex flex-col min-w-0 gap-6 ${messages.length>0&&`flex-1`} overflow-y-scroll pt-4`} ref={messagesContainerRef}>
